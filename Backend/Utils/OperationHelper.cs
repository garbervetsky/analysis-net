...
namespace Backend.Utils
{
	...
	{
		public static MethodCallOperation ToMethodCallOperation(OperationCode opcode)
		{
			switch (opcode)
			{
				case OperationCode.Call: return MethodCallOperation.Static;
				case OperationCode.Callvirt: return MethodCallOperation.Virtual;
				case OperationCode.Jmp: return MethodCallOperation.Jump;
